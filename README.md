...
```sh
zig fetch --save https://github.com/bronter/wgpu_native_zig/archive/refs/tags/v3.0.1.tar.gz
```
...
.{
    ...
    .dependencies = .{
        ...
        .wgpu_native_zig = .{
            ...
            // or a tagged release:
            // .url = "https://github.com/bronter/wgpu_native_zig/archive/refs/tags/v3.0.1.tar.gz`
